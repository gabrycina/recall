...
async function showQuiz(transcript) {
  if (quizInProgress) {
  ...
  try {
    ...
    quizContainer.querySelector('#submit-answer').addEventListener('click', () => checkAnswer(correctAnswer));
...
async function generateQuestionFromContent(transcript) {
...
function generateFallbackQuestion() {
  const videoTitle = document.querySelector('.title.ytd-video-primary-info-renderer').textContent;
  return {
