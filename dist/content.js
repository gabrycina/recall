...
function showQuiz(transcript) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const { question, options, correctAnswer } = yield generateQuestionFromContent(transcript);
...
function generateQuestionFromContent(transcript) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield callOpenAI(prompt);
...
function generateSimpleQuestion(transcript) {
...
function generateOptions(correctAnswer, keywords) {
...
function generateFallbackQuestion() {
    var _a;
    const videoTitle = ((_a = document.querySelector('.title.ytd-video-primary-info-renderer')) === null || _a === void 0 ? void 0 : _a.textContent) || 'this video';
    return {
...
function callOpenAI(prompt) {
    return __awaiter(this, void 0, void 0, function* () {
        const apiKey = yield getOpenAIKey();
